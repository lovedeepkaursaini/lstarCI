...
# with command line options: STEP2 --step RAW2DIGI,L1Reco,RECO --conditions START53_V7C::All --pileup 2012_Summer_50ns_PoissonOOTPU --datamix NODATAMIXER --eventcontent AODSIM --datatier AODSIM --filein file:out_STEP1.root --fileout out_STEP_STEP2.root
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('out_STEP_STEP2.root'),
